...
import jwt from "jsonwebtoken"; // Importa a biblioteca JWT para verificar e decodificar tokens
 ...
 * @param {string} role - O papel (role) exigido para acesso.
 */
function authorizeRole(role) {
  return (req, res, next) => {
    // Verifica se o usuário (injetado por authenticateToken) possui a role exigida
